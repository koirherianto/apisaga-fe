    ...
    <div class="container px-6 mx-auto">
        <nav class="flex flex-col py-6 sm:flex-row sm:justify-between sm:items-center">
            ...
            <div class="flex items-center mt-2 -mx-2 sm:mt-0">
                <a href="/login" class="px-3 py-1 text-sm font-semibold text-white transition-colors duration-300 transform border-2 rounded-md hover:bg-gray-700">Sign In</a>
                <a href="/register" class="px-3 py-2 mx-2 text-sm font-semibold text-white transition-colors duration-300 transform bg-black rounded-md hover:bg-gray-800">Sign Up</a>
            </div>
        </nav>

        <div class="flex flex-col items-center py-6 lg:h-[36rem] lg:flex-row">
            <div class="lg:w-1/2">
                <h2 class="text-3xl font-semibold text-gray-100 lg:text-4xl">Apisaga</h2>

                <h3 class="mt-2 text-2xl font-semibold text-gray-100">
                    Hello <span class="text-blue-400">Devaloper</span>
                </h3>

                <p class="mt-4 text-gray-100">Create and manage your program documentation effortlessly with Apisaga. No code, no hosting required. Sign up now!</p>
            </div>
